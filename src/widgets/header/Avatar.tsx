...
export const Avatar = forwardRef<HTMLButtonElement, AvatarProps>(function Avatar(
  ...
  return (
    <button
      ...
      type="button"
      aria-label="Профиль"
      className={`box-border flex h-[32px] w-[32px] shrink-0 items-center justify-center overflow-hidden rounded-[36px] border-[0.3px] border-solid border-transparent bg-[#FFFFFF] p-0 text-[18px] font-semibold leading-none tracking-[-0.036px] text-[#8E8BED] [appearance:none] ${className ?? ""}`}
      style={{
        background:

...
export function ButtonPrimary({ children, className, ...props }: ButtonPrimaryProps) {
  return (
    <button
      className={`flex h-[32px] items-center justify-center gap-[6px] whitespace-nowrap rounded-[36px] bg-[#c8ff02] px-[24px] py-[8px] text-[#1A1A1A] transition-colors duration-200 ease-out hover:bg-[#A8E000] active:translate-y-[0.5px] active:bg-[#96C800] ${className ?? ""}`}
      {...props}
    >

...
export function ProfileDropdown({ onClose }: ProfileDropdownProps) {
  ...
  return (
    <HeaderDropdownPanel className="profile-dropdown-panel box-border flex w-[412px] flex-col items-start justify-center gap-[24px] rounded-[31px] p-[24px] text-[#1A1A1A]">

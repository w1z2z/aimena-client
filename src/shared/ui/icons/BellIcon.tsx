...
/** Intrinsic size matches viewBox — keep CSS width/height in sync. */
export const BELL_ICON_SIZE = { width: 13.8125, height: 15.4372 } as const;
...
export function BellIcon({ className, ...props }: IconProps) {
  return (
    <svg
      ...
      viewBox={`0 0 ${BELL_ICON_SIZE.width} ${BELL_ICON_SIZE.height}`}
      fill="none"
      aria-hidden

...
export const NAV_CHAT_ICON_SIZE = { width: 20, height: 20 } as const;

/** assets/chat.svg — mobile bottom nav */
export function NavChatIcon({ className, ...props }: IconProps) {
  return (
    <svg
      width={NAV_CHAT_ICON_SIZE.width}
      height={NAV_CHAT_ICON_SIZE.height}
      viewBox="0 0 24 24"
      fill="none"
      aria-hidden
